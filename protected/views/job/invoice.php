...
<br/>
<br/>
<div id="jobname"><?php echo CHtml::encode($model->NAME);?></div>
<div id="customer">
...
<table id="date_invoice">
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td class="right"><?php echo $model->ID;?></td>
	</tr>
</table>
...
<table id="items">
	...
	<tr class="item_row">
		...
		<td><?php echo $formatter->formatNumber(GlobalConstants::SETUP_FEE_QUANTITY_DEFAULT);?></td>
		<td><?php echo $formatter->formatCurrency(GlobalConstants::SETUP_FEE_AMOUNT_DEFAULT);?></td>
